...
public class Homework5Grader {
    ...
    public static void main(String[] paramArrayOfString) {
        org.junit.runner.Result localResult = org.junit.runner.JUnitCore.runClasses(new Class[]{ParseMovieRatingsTest.class, GetAlphabeticalMoviesTest.class, GetAlphabeticalMoviesAboveRatingTest.class, RemoveAllRatingsBelowTest.class});
        ...
        if (i == 0) {
            ...
            int m = 1;
            for (org.junit.runner.notification.Failure localFailure : localResult.getFailures()) {
