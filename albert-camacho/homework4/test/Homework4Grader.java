...
public class Homework4Grader {
    ...
    public static void main(String[] paramArrayOfString) {
        org.junit.runner.Result localResult = org.junit.runner.JUnitCore.runClasses(new Class[]{DepthTest.class, HeightTest.class, FindNodeTest.class, IsBalancedNodeTest.class, IsBalancedTreeTest.class});
