...
import project.common.DoubleLinkedList;
...
public class Main {
    ...
    private static void test_double_linked_list_structure() {
        ...
        DoubleLinkedList<Student, Subject> students = new DoubleLinkedList<>();
    ...
    private static void test_parent_list_structure() {
        // Create list, add elements and prints the list
