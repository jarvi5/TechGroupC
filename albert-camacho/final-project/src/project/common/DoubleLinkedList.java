...
public class DoubleLinkedList<E, V> implements DoubleList<E> {
    private int size;
    private Node<E, V> firstNode;
    private Node<E, V> lastNode;
    ...
    public void delete(E element) {
        Node<E, V> node = getNode(element);
        // Remove the firstNode
        if (node.getPrevious() == null) {
            firstNode = (Node<E, V>) node.getNext();
        } else {
        ...
        if (node.getNext() == null) {
            lastNode = (Node<E, V>) node.getPrevious();
        }else {
     ...
     */
    public DoubleList<V> getChildren(E element) {
        DoubleList<V> children = new DoubleLinkedList<>();

        if (hasChild(element)) {
            INode<V> node = getNode(element).getChild();
            while (node != null) {
    ...
    private Node<E, V> getNode(E element){
        Node<E, V> node = firstNode;
        while (node != null) {
            if (element.equals(node.getElement())){
                return node;
            }
            node = (Node<E, V>) node.getNext();
        }
