...
public class ParseMovieRatingsTest
{
  ...
  public void setUp()
  {
    ...
    ratings.add(new UserMovieRating("singles", 5));
    ratings.add(new UserMovieRating("singles", 4));
    
    ratings.add(new UserMovieRating("zootopia", 4));
    ratings.add(new UserMovieRating("zootopia", 2));
  }
  ...
  public void testNormalInput() {
    try {
      TreeMap localTreeMap = MovieRatingsParser.parseMovieRatings(ratings);
      if (localTreeMap == null) {
  ...
  public void testIgnoreNullTitle() {
    ratings.add(new UserMovieRating(null, 5));
    try
    {
      TreeMap localTreeMap = MovieRatingsParser.parseMovieRatings(ratings);
      if (localTreeMap == null) {
  ...
  public void testIgnoreEmptyTitle() {
    ratings.add(new UserMovieRating("", 5));
    try
    {
      TreeMap localTreeMap = MovieRatingsParser.parseMovieRatings(ratings);
      if (localTreeMap == null) {
  ...
  public void testIgnoreCase() {
    ratings.add(new UserMovieRating("ZOOTOPIA", 3));
    try
    {
      TreeMap localTreeMap = MovieRatingsParser.parseMovieRatings(ratings);
      if (localTreeMap == null) {
