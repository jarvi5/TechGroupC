public class Homework6Grader
{
    ...
    {
        try {
            java.io.File localFile1 = new java.io.File("txt_files/graph_builder_test.txt");
        ...
        try {
            java.io.File localFile2 = new java.io.File("txt_files/is_hamiltonian_path_test.txt");
