...
{
    public static final String FILENAME = "txt_files/graph_builder_test.txt";
    ...
    public void testNullSrc() {
        UndirectedGraph localUndirectedGraph = GraphBuilder.buildUndirectedGraph("txt_files/graph_builder_test.txt");
    ...
    public void testDistance1Directed() {
        DirectedGraph localDirectedGraph = GraphBuilder.buildDirectedGraph("txt_files/graph_builder_test.txt");
