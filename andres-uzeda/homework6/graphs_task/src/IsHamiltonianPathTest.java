...
{
    public static final String FILENAME = "txt_files/is_hamiltonian_path_test.txt";
    ...
    public void testNullLinkedList() {
        UndirectedGraph localUndirectedGraph = GraphBuilder.buildUndirectedGraph("txt_files/is_hamiltonian_path_test.txt");
    ...
    public void testValidDirected() {
        List localList = createValidPath();
        DirectedGraph localDirectedGraph = GraphBuilder.buildDirectedGraph("txt_files/is_hamiltonian_path_test.txt");
