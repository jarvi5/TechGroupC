...
public class FindNodeTest
{
    ...
    public void testTargetIsRoot() {
        try {
            ...
            Assert.assertEquals("findNode returned incorrect Node when looking for value that is root", "dog", localNode);
        }
    ...
    public void testTargetIsLeftChildOfRoot() {
        try {
            ...
            Assert.assertEquals("findNode returned incorrect Node when looking for value that is left child of root", "cat", localNode);
        }
        catch (Exception localException) {
    ...
    public void testTargetIsRightChildOfRoot() {
        try {
            ...
            Assert.assertEquals("findNode returned incorrect Node when looking for value that is right child of root", "pig", localNode);
        }
        catch (Exception localException) {
    ...
    public void testTargetIsGrandchildOfRoot() {
        ...
        try
        {
            ...
            Assert.assertEquals("findNode returned incorrect Node when looking for value that is grandchild of root", "ant", localNode);
        }
        catch (Exception localException) {
