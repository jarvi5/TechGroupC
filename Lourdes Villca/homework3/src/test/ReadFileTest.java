...
public class ReadFileTest
{
    ...
    public void testTextOneSentence() {
        File localFile = new File("src/test/test1.txt");
        if (!localFile.exists()) {
        ...
        try {
            List localList = Analyzer.readFile("src/test/test1.txt");
            if (localList == null)
    ...
    public void testScoreOneSentence() {
        File localFile = new File("src/test/test2.txt");
        if (!localFile.exists()) {
        ...
        try
        {
            List localList = Analyzer.readFile("src/test/test2.txt");
            if (localList == null)
                Assert.fail("readFile returns null when processing file with one sentence");
            if (localList.isEmpty()) {
                Assert.fail("readFile returns empty List when processing file with one sentence");
    ...
    public void testMultipleSentencesPositiveScores() {
        File localFile = new File("src/test/test3.txt");
        if (!localFile.exists()) {
        ...
        try
        {
            List localList = Analyzer.readFile("src/test/test3.txt");
            if (localList == null)
    ...
    public void testMultipleSentencesNegativeScores() {
        File localFile = new File("src/test/test4.txt");
        if (!localFile.exists()) {
        ...
        try
        {
            List localList = Analyzer.readFile("src/test/test4.txt");
            if (localList == null)
                Assert.fail("readFile returns null when processing file with multiple sentences");
            if (localList.isEmpty()) {
                Assert.fail("readFile returns empty List when processing file with multiple sentences");
    ...
    public void testIgnoreInvalidSentenceWithNoScore() {
        File localFile = new File("src/test/test5.txt");
        if (!localFile.exists()) {
        ...
        try
        {
            List localList = Analyzer.readFile("src/test/test5.txt");
            if (localList == null)
    ...
    public void testIgnoreInvalidSentenceWithNoText() {
        File localFile = new File("src/test/test6.txt");
        if (!localFile.exists()) {
        ...
        try
        {
            List localList = Analyzer.readFile("src/test/test6.txt");
            if (localList == null)
    ...
    public void testIgnoreInvalidSentenceWithScoreOutsideRange() {
        File localFile = new File("src/test/test7.txt");
        if (!localFile.exists()) {
        ...
        try
        {
            List localList = Analyzer.readFile("src/test/test7.txt");
            if (localList == null)
    ...
    public void testIgnoreInvalidSentenceWithScoreNotAnInteger() {
        File localFile = new File("src/test/test8.txt");
        if (!localFile.exists()) {
        ...
        try
        {
            List localList = Analyzer.readFile("src/test/test8.txt");
            if (localList == null)
