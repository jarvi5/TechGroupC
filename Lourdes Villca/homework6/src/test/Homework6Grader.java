...
public class Homework6Grader
{
  ...
  {
    try {
      java.io.File localFile1 = new java.io.File("src/test/graph_builder_test.txt");
    ...
    try {
      java.io.File localFile2 = new java.io.File("src/test/is_hamiltonian_path_test.txt");
