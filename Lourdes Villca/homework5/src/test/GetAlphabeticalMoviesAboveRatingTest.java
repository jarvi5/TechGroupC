...
public class GetAlphabeticalMoviesAboveRatingTest
{
  ...
  public void testReturnMoviesAbove() {
    try {
      List localList = MovieRatingsProcessor.getAlphabeticalMoviesAboveRating(map, 2);
      if (localList == null) {
  ...
  {
    try {
      List localList = MovieRatingsProcessor.getAlphabeticalMoviesAboveRating(map, 1);
      if (localList == null) {
        Assert.fail("getAlphabeticalMoviesAboveRating returns null for valid input");
      }
  ...
  public void testAllMoviesBelowThreshold() {
    try {
      List localList = MovieRatingsProcessor.getAlphabeticalMoviesAboveRating(map, 8);
      if (localList == null) {
  ...
  public void testAllMoviesAbove() {
    try {
      List localList = MovieRatingsProcessor.getAlphabeticalMoviesAboveRating(map, 0);
      if (localList == null) {
