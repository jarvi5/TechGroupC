...
public class ReadFileTest {
    ...
    public void testTextOneSentence() {
        File var1 = new File("./src/test/resources/test1.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test1.txt");
            if (var2 == null) {
    ...
    public void testScoreOneSentence() {
        File var1 = new File("./src/test/resources/test2.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test2.txt");
            if (var2 == null) {
                Assert.fail("readFile returns null when processing file with one sentence");
            }
    ...
    public void testMultipleSentencesPositiveScores() {
        File var1 = new File("./src/test/resources/test3.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test3.txt");
            if (var2 == null) {
    ...
    public void testMultipleSentencesNegativeScores() {
        File var1 = new File("./src/test/resources/test4.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test4.txt");
            if (var2 == null) {
                Assert.fail("readFile returns null when processing file with multiple sentences");
            }
    ...
    public void testIgnoreInvalidSentenceWithNoScore() {
        File var1 = new File("./src/test/resources/test5.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test5.txt");
            if (var2 == null) {
    ...
    public void testIgnoreInvalidSentenceWithNoText() {
        File var1 = new File("./src/test/resources/test6.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test6.txt");
            if (var2 == null) {
    ...
    public void testIgnoreInvalidSentenceWithScoreOutsideRange() {
        File var1 = new File("./src/test/resources/test7.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test7.txt");
            if (var2 == null) {
    ...
    public void testIgnoreInvalidSentenceWithScoreNotAnInteger() {
        File var1 = new File("./src/test/resources/test8.txt");
        if (!var1.exists()) {
        ...
        try {
            List var2 = Analyzer.readFile("./src/test/resources/test8.txt");
            if (var2 == null) {
