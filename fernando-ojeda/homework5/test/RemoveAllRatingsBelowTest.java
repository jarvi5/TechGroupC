...
public class RemoveAllRatingsBelowTest
{
    ...
    public void testModifySomeMovies() {
        try {
            TreeMap localTreeMap = MovieRatingsProcessor.removeAllRatingsBelow(map, 2);
            if (localTreeMap == null) {
            ...
            Assert.assertEquals("removeAllRatingsBelow removes some entries from input TreeMap when some movies have ratings to be removed", 4L, map.size());

            PriorityQueue localPriorityQueue = (PriorityQueue)map.get("inception");
            ...
            localPriorityQueue = (PriorityQueue)map.get("ratatouille");
            if (localPriorityQueue == null) {
                Assert.fail("removeAllRatingsBelow removes some entries from input TreeMap when some movies have ratings to be removed");
            }
    ...
    public void testModifyNoMovies()
    {
        try
        {
            TreeMap localTreeMap = MovieRatingsProcessor.removeAllRatingsBelow(map, 0);
            if (localTreeMap == null) {
            ...
            PriorityQueue localPriorityQueue = (PriorityQueue)map.get("sabrina");
            if (localPriorityQueue == null) {
            ...
            localPriorityQueue = (PriorityQueue)map.get("inception");
            if (localPriorityQueue == null) {
                Assert.fail("removeAllRatingsBelow removes some entries from input TreeMap when no movies have ratings to be removed");
            }
            if (localPriorityQueue.size() != 2) {
            ...
            localPriorityQueue = (PriorityQueue)map.get("grease");
            if (localPriorityQueue == null) {
                Assert.fail("removeAllRatingsBelow removes some entries from input TreeMap when no movies have ratings to be removed");
            }
            if (localPriorityQueue.size() != 2) {
...
//            Assert.assertTrue("removeAllRatingsBelow should return remove all elements from input TreeMap when all ratings for all movies are to be removed", map.isEmpty());
        }
        catch (Exception localException) {
    ...
    public void testRemoveBelowButNotEqual() {
        map.remove("sabrina");
        map.remove("grease");
        map.remove("inception");
        try {
            TreeMap localTreeMap = MovieRatingsProcessor.removeAllRatingsBelow(map, 4);
            if (localTreeMap == null) {
                Assert.fail("removeAllRatingsBelow returns null when some movies have ratings to be removed");
            }
            ...
            PriorityQueue localPriorityQueue = (PriorityQueue)map.get("ratatouille");
            if (localPriorityQueue == null) {
