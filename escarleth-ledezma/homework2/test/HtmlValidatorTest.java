...
{
    private String pathToTestFiles = "./escarleth-ledezma/homework2/";

    public HtmlValidatorTest() {}

    private Stack<HtmlTag> validateTestFile(String paramString) {
        try {
    ...
    {
        try {
            Stack localStack = validateTestFile("test/test1.html");
            if (localStack == null)
    ...
    public void testFile2() {
        try {
            Stack localStack1 = validateTestFile("test/test2.html");
            if (localStack1 == null) {
    ...
    public void testFile3() {
        try {
            Stack localStack1 = validateTestFile("test/test3.html");
            if (localStack1 == null) {
    ...
    public void testFile4() {
        try {
            Stack localStack = validateTestFile("test/test4.html");
    ...
    {
        try {
            Stack localStack = validateTestFile("test/test5.html");
            if (localStack == null) {
                Assert.fail("isValidHtml returns null for a valid HTML file input.");
            }
            Assert.assertTrue("isValidHtml should return an empty stack for a valid HTML file input.", localStack.isEmpty());
    ...
    public void testFile6() {
        try {
            Stack localStack1 = validateTestFile("test/test6.html");
            if (localStack1 == null) {
    ...
    public void testFile7() {
        try {
            Stack localStack = validateTestFile("test/test7.html");
