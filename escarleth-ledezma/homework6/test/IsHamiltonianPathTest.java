...
{
    public static final String FILENAME = "./escarleth-ledezma/homework6/test/is_hamiltonian_path_test.txt";
    ...
    public void testNullLinkedList() {
        UndirectedGraph localUndirectedGraph = GraphBuilder.buildUndirectedGraph(FILENAME);
    ...
    public void testValidDirected() {
        List localList = createValidPath();
        DirectedGraph localDirectedGraph = GraphBuilder.buildDirectedGraph(FILENAME);
